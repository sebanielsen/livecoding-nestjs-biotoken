        ...
        },
        {
          ...
          "type": "function"
            ...
            constructor() {
                ...
                this.contract = new ethers.Contract("0x0000000000000000000000000000000000001010", this.abi, this.provider);
            }
        
            async getDecimalValue(): Promise<number> {
                const value = await this.contract.decimals(); // Call your contract function
                return value; // Convert to a decimal number
            }
        }